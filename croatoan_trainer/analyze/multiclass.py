    ...
    def __init__(
        ...
        Args:
            ...
            `postprocess_fn` (callable):
                ...
                For multiclassification problem it is important to have exact
                class as final output. So, for example, if you have list of
                logits as your model output, define function that will convert
                your logits into belonging to some class (just maximum of
                these logits). Default is `None`.
        """
